...
El mapa es __una cadena de texto__ multi línea donde cada caracter representa una casilla. Los niños se representan por números del `1` al `9` y __Santa Claus__ por la letra `S`. El resto de casillas son `.`

__Santa Claus__ sólo puede moverse hacia arriba, abajo, izquierda o derecha, y cada movimiento cuenta como 1 km. Además, siempre empieza en la posición `S` y debe entregar los regalos en orden, del `1` al `9`.
