...
Un ratoncillo llamado __midurat__ 🐭, que vió ayer el festín escondido, está relamiéndose los bigotes al ver todos los manjares que hay en el comedor.
...
El ratoncillo se puede mover en 4 direcciones: __up, down, left, right__ y el comedor es una matriz (un array de arrays) donde cada posición puede ser:
